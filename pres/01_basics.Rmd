...
```{r vectorplots, fig.cap="Projected CRSs (source: Geocomputation with R and [progonos.com/furuti](http://progonos.com/furuti/))", out.width="40%", fig.show='hold', echo=FALSE}
