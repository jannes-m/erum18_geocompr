...
- Geographic data only represent a simplified representation of the world. So we decide what we display for which purpose.
--

- Two data models for representing geographic data: the vector and the raster data model
