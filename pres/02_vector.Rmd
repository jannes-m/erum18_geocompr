...
- geographical Coordinate Reference Systems (CRS) use one specific ellipsoid (WGS84) and span the entire world
- projected CRS are localized to minimize visual distortion in a particular region (usually use a specific ellipsoid which is especially suitable for a this particular part of the Earth)
...
- [Projections](https://geocompr.robinlovelace.net/transform.html#reproj-geo-data)
